...
A Helm chart for route-timeout-validator
...
| config | object | `{"name":"operator-config","secondsTimeout":600}` | Name of the ConfigMap used for configuration. |
...
| image.manager.repository | string | `"ghcr.io/dana-team/route-timeout-validator"` | The repository of the manager container image. |
